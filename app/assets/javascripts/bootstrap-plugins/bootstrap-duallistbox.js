  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.elements = {
        ...
        filterInput1: $('.box2 .filter', this.container),
        filterInput2: $('.box1 .filter', this.container),
        filterClear1: $('.box2 .clear1', this.container),
        filterClear2: $('.box1 .clear2', this.container),
        label1: $('.box2 > label', this.container),
        label2: $('.box1 > label', this.container),
        info1: $('.box2 .info', this.container),
        info2: $('.box1 .info', this.container),
        select1: $('.box2 select', this.container),
        select2: $('.box1 select', this.container),
        moveButton: $('.box2 .remove', this.container),
        removeButton: $('.box1 .move', this.container),
        moveAllButton: $('.box2 .removeall', this.container),
        removeAllButton: $('.box1 .moveall', this.container),
